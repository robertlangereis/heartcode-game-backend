...
describe("finished()", () => {
  it("should finish when there are no moves left", () => {
    const board: Board = [["o", "o", "x"], ["x", "x", "o"], ["x", "o", "o"]];
